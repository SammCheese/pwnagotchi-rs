...
impl DisplayTrait for DisplayImpl {
    fn layout(&mut self) -> &Layout { &self.layout }
    fn initialize(&self) { println!("Not Implemented"); }
    fn render(&self, _canvas: &mut RgbaImage) { println!("Not Implemented"); }
    fn clear(&self) { println!("Not Implemented"); }
}
